...
const sendWhatsappMessage = asyncHandler(async (req, res) => {
  ...
  client.messages
    .create({
      ...
      body: `Hello ${customerName}! Your EMI of Amount Rs 8000 is due on ${date}. Collection Agent: Jigar Shah will be visiting on  ${date} for the amount collection. Thank you! Team Finance Buddy`,
